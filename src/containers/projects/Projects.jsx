...
const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      summary:
        "This was an Sports English camp that i designed a simple website for so they could inform customers the type of programs that they offer",
    },
    {
      name: "GameHub",
      image: gamehub,
      ...
      summary:
        "This was an experimental project working with react-query and Zustand",
    },
    {
